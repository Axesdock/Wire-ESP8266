...
//const char* ssid_sta_mode    = "IITBhilai";
//const char* password_sta_mode = "";
...
void setup() {
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *request){
    String content = "{";
    content = content + prep_json("ssid",ssid_sta_mode) +",";
    content = content + prep_json("password",password_sta_mode) +",";
    content = content + prep_json("ws_url",e_ws_url) +",";
    content = content + prep_json("ws_port",e_ws_port) +",";
